...
<html lang="en">
  ...
  <div class="container">
    ...
    <section style="background-image: url('images/sus.jpg');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-primary">Sustainable</span> Travel Adventures</h2>
            <p class="fs-4">Eco-Friendly Journeys Await.</p>
            <div class="d-flex gap-3">
              <a href="#" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Explore Eco Tours</a>
              <a href="#" class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Join Now</a>
            </div>
            <div class="row my-5">
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">4000+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Desa Wisata Rintisan</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">900+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Desa Wisata Berkembang</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">300+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Desa Wisata Maju</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">30+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Desa Wisata Mandiri</p></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Eco-friendly Travel</h5>
                    <p class="card-text">Nikmati pengalaman wisata ramah lingkungan.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card border-0 bg-secondary rounded-0 p-4 text-light">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Local Community Support</h5>
                    <p class="card-text">Kami bekerja dengan komunitas lokal untuk mendukung pembangunan berkelanjutan.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card border-0 bg-danger rounded-0 p-4 text-light">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Trust & Safety</h5>
                    <p class="card-text">Keamanan dan kenyamanan Anda adalah prioritas kami dalam setiap perjalanan.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="category-carousel swiper">
              <div class="swiper-wrapper" style="display: flex; justify-content: center;">
                <a href="{{ route('customer.wisata.filter', 'Alam') }}" class="nav-link swiper-slide text-center">
                  <img src="images/category-thumb-1.jpg" style="border-radius: 20px;" alt="Category Thumbnail">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad d-flex align-items-center large bg-info block-1" style="background: url('images/25.jpg') no-repeat; background-size: cover; border-radius:20px;">
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('images/23.jpg') no-repeat;background-size: cover; border-radius:20px;">
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('images/24.jpg') no-repeat;background-size: cover; border-radius:20px;">
                <div class="banner-content align-items-center p-5">
                  <div class="content-wrapper text-light">
